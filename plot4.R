...
plot(data$data,data$Global_active_power,ylab='Global Active Power',xlab='',type='line')
plot(data$data,data$Voltage,ylab='Voltage',xlab='datetime',type='line')
...
plot(data$data,data$Global_reactive_power,xlab='datetime',ylab='Global_reactive_power',type='line')
